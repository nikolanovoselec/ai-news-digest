...
- "details" is a plaintext body grounded in the candidate's "snippet" field. The snippet IS the article body; read it and compress it into a summary. DO NOT invent facts not present in the snippet. DO NOT write boilerplate like "This article explores..." or "The announcement outlines...". DO NOT restate the title. If the snippet provides rich content (≥ 500 characters), target 200–250 words (~1100–1400 characters) split into 2–3 paragraphs separated by the JSON escape sequence "\\n" (backslash-n) — the app un-escapes it back to a real newline on render. Paragraphs are 2–4 full sentences. Cover (a) what happened — the concrete facts the snippet reports, (b) the technical substance — what the change actually does, (c) the practical impact — what changes for the reader. If the snippet is SHORT (< 500 characters) or ABSENT, write exactly 2–3 honest sentences paraphrasing whatever the snippet/title says — DO NOT pad with fake detail. A short honest summary beats a long hallucinated one every single time. No Markdown, no HTML, no bullet prefixes.
