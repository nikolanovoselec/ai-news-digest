...
- "details" is a plaintext body of 2–3 paragraphs totalling 200–250 words (~1100–1400 characters). Each paragraph is 2–4 sentences separated by a single newline. Cover what happened, the technical substance (not just the headline framing), and the practical impact or what changes for the reader. No Markdown, no HTML, no bullet prefixes.
