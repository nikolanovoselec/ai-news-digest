...
export const CURATED_SOURCES: readonly CuratedSource[] = [
  ...
  },
  {
    slug: 'netlify-blog',
    name: 'Netlify Blog',
    feed_url: 'https://www.netlify.com/blog/index.xml',
    kind: 'rss',
    tags: ['cloud', 'serverless'],
  },
  {
  ...
  {
    slug: 'perplexity-blog',
    name: 'Perplexity Blog',
    feed_url: 'https://www.perplexity.ai/feed/rss.xml',
    kind: 'rss',
    tags: ['ai', 'genai'],
  },
  ...
  // ---- MCP / agentic -----------------------------------------------------
  {
    ...
    kind: 'rss',
    tags: ['ai', 'mcp', 'agenticai'],
  },
  {
    slug: 'modelcontextprotocol',
    name: 'Model Context Protocol',
    feed_url: 'https://modelcontextprotocol.io/feed.xml',
    kind: 'rss',
    tags: ['mcp', 'agenticai'],
  },
  {
  ...
  },
  {
    slug: 'illumio-blog',
    name: 'Illumio Blog',
    feed_url: 'https://www.illumio.com/blog/feed',
    kind: 'rss',
    tags: ['microsegmentation', 'zero-trust'],
  },
  {
  ...
  },
  {
    slug: 'datadog-blog',
    name: 'Datadog Blog',
    feed_url: 'https://www.datadoghq.com/blog/feed.xml',
    kind: 'rss',
  ...
  },
  {
    slug: 'turso-blog',
    name: 'Turso Blog',
    feed_url: 'https://turso.tech/rss.xml',
    kind: 'rss',
    tags: ['cloud', 'serverless'],
  },
  ...
  },
  {
    slug: 'honeycomb-blog',
    name: 'Honeycomb Blog',
    feed_url: 'https://www.honeycomb.io/blog/feed',
    kind: 'rss',
    tags: ['observability'],
  },
] as const;
