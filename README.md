...
- **No ads.** No tracking pixels, no Hotjar, no A/B paywall experiment.
- **No interruptions.** No cookie banner, no paywall, no newsletter pop-up, no auto-playing video, no exit-intent modal, no chat widget asking if it can help me find what I'm looking for. (When I'm reading an article, I am in fact looking for the article.)
- **No fake news.** The LLM summarises real sources and links straight back. If the source is lying, the source is lying. I just put fewer adjectives on it.
...
| LLM | [Workers AI](https://developers.cloudflare.com/workers-ai/): `granite-4.0-h-micro` (single-model architecture; integration canary, 131K context) |
