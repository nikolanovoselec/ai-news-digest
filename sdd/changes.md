...
- REQ-PIPE-016 changed: token and cost totals now include completed LLM calls retried by the model tag-fanout guard, while article-ingestion and dedupe counters still advance only once per completed chunk.
