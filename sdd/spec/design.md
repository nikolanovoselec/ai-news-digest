...
3. Inputs render with a minimum 16 px font size to prevent iOS zoom-on-focus. <!-- @impl: src/styles/global.css::--color-bg -->
4. Every interactive element shows a visible focus ring on keyboard focus. <!-- @impl: src/styles/global.css::--color-bg -->
5. All interactive elements have a minimum 44 × 44 pixel touch target. <!-- @impl: src/styles/global.css::--color-bg -->
