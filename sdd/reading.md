...
5. The grid shows the 29 most-recently-ingested articles matching the user's active tags, ordered by ingested-at descending with published-at as a tiebreaker. "Ingested" wins over "published" so a new scrape always bubbles its articles to the top of the dashboard, and an older-pubDate article that was ingested after a newer-pubDate one never overtakes it.
