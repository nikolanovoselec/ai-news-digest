...
| `models.ts` | `MODELS` catalog, `DEFAULT_MODEL_ID` (`@cf/google/gemma-4-26b-a4b-it` for the 2026-06-06 develop/integration canary; prior 120B baseline and 20B rollback are recorded in [AD48](decisions/README.md#ad48-dedup-cost-reduction-borderline-rerank-watermark-batched-rerank-call-pipeline-wide-gpt-oss-20b), current Gemma retest in [AD50](decisions/README.md#ad50-gemma-4-26b-integration-canary-for-pipeline-default)), cost estimator (cost accounting still live for chunk + discovery LLM calls; per-user model selection *Deprecated 2026-04-23 with REQ-SET-004*) | [REQ-PIPE-006](../sdd/generation.md#req-pipe-006-scrape_runs-aggregation-surfaces-stats-history-and-in-flight-progress), [REQ-SET-004](../sdd/settings.md#req-set-004-server-side-model-catalog-and-default) |
