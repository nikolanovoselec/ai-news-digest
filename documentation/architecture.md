...
| `migrations/0001_initial.sql` | Pre-launch initial schema; replay-required because 0003's DROP statements assume these tables exist before being dropped | (replay base) |
| `migrations/0002_article_tags.sql` | Pre-launch tag columns; same replay-base invariant as 0001 | (replay base) |
