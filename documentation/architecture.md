...
| `src/queue/cleanup.ts` | Daily 3-pass cleanup: retention, stuck-tag prune, orphan-tag KV sweep, orphan-run retirement (force-fails runs still marked `running` well past the longest plausible tick duration so stalled rows surface as failed rather than staying `running` indefinitely) | [REQ-PIPE-005](../sdd/generation.md#req-pipe-005-fourteen-day-retention-with-starred-exempt-cleanup), [REQ-DISC-006](../sdd/discovery.md#req-disc-006-stuck-tag-retention), [REQ-PIPE-007](../sdd/generation.md#req-pipe-007-orphan-tag-source-cleanup), [REQ-PIPE-016 AC 3](../sdd/generation.md#req-pipe-016-scrape_runs-idempotency-and-stuck-run-cleanup) |
