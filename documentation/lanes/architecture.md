...
| `blocked-publishers.ts` | Hard publisher blocklist. Drops financial, press-wire, Show HN, and housing-wire noise before clustering, embedding, or LLM processing. Checks host suffixes plus RSS source-name tokens because Google News wrappers hide publisher hosts. | [REQ-PIPE-011](../../sdd/spec/generation.md#req-pipe-011-candidate-filtering-rules) AC 3 |
