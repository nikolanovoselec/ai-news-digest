...
Moved to its own page so this reference stays under its line budget. See [api-reference-admin.md](api-reference-admin.md) for the full admin endpoint surface (force-refresh, embed-backfill, historical-dedup, dedup-status, pipeline-run POST/GET, pipeline-status, dedup-diag). Backlinks to REQ-OPS-005/008, REQ-PIPE-001/003/009, and REQ-AUTH-001 AC 8a/8d/9/9g/10 live there.
